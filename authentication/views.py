...
def register_user(request):
    if request.method == 'POST':
        ...
        if role_artist:
            ...
            cur.execute("INSERT INTO artist (id, email_akun, id_pemilik_hak_cipta) VALUES (%s, %s, %s)", (uuid.uuid4(), email, id_pemilik_hak_cipta))
        ...
        """, (id_pemilik_hak_cipta, rate_royalti))
            cur.execute("INSERT INTO songwriter (id, email_akun, id_pemilik_hak_cipta) VALUES (%s, %s, %s)", (uuid.uuid4(), email, id_pemilik_hak_cipta))
